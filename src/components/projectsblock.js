...
export const Projectsblock = (props) => {
    ...
    return(
        ...
        <Container style={{minHeight:'100vh'}} fluid={true} className="bg-black py-4 d-flex justify-content-center align-items-center">
            <Container>
                <Row className='text-center m-0' style={{width:'100%'}}>
                    <Col xs="2" className="">
                        <Verticalline offset='20' />
                    </Col>
                    ...
                    <Col xs="2" className='text-white'>
                        ceklmwkl wllk welk lkw elk wel  k s
                    </Col>
                </Row>
            </Container>
        </Container>
