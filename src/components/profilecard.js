...
export const Profilecard = (props) => {
    return(
        <Row className='text-center text-gold m-0' style={{height:'100%', width:'100%'}}>
...
export const Foundercard = (props) =>{
    return(
        <Row >
            <Col xs="12" xl="4">
                <Row>
                    <Col xs='12' sm='4' xl='12' className='p-2' style={{border:'solid gold', borderWidth:'1px 0px 0px 1px'}}>
