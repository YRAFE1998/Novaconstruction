...
export const Whoweareblock = (props) => {
    return(
        <Styledblock bg='black' offset='0' title=''>
...
export const Partnershipblock = (props) => {
    return(
    <Styledblock bg='white' offset='5' title='PARTNERSHIP'>
...
export const OurTeamBlock = (props) => {
    return(
    <Styledblock bg='black' offset='5' title='OUR TEAM' subtitle='OUR AMAZING TEAM'>
        <Secondary5 style={{lineHeight:'2.4'}} className="mt-4 secondary">
        </Secondary5>
        <Container className="mt-5">
            <Row>
...
export const Clientsblock = (props) => {
    return(
    <Styledblock bg='white' offset='5' title='CLIENTS' subtitle='We have worked with some amazing companies around the world'>
        <Container>
            <Row className='mt-5'>
